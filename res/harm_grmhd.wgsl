...
struct HarmPrim {
    ...
    state3: vec4f, // staggered magnetic-face flux (not rendered)
};
...
fn sampleHarmCell(irIn: i32, itIn: i32, ipIn: i32, n1: i32, n2: i32, n3: i32) -> HarmPrim {
    ...
    let vecIdx = localIdx * 4;
    var out: HarmPrim;
    
    if (slab == 0) {
        out.state0 = field0_raw[vecIdx];
        out.state1 = field0_raw[vecIdx + 1]; out.state2 = field0_raw[vecIdx + 2]; out.state3 = field0_raw[vecIdx + 3];
    } else if (slab == 1) {
        out.state0 = field1_raw[vecIdx];
        out.state1 = field1_raw[vecIdx + 1]; out.state2 = field1_raw[vecIdx + 2]; out.state3 = field1_raw[vecIdx + 3];
    } else if (slab == 2) {
        out.state0 = field2_raw[vecIdx];
        out.state1 = field2_raw[vecIdx + 1]; out.state2 = field2_raw[vecIdx + 2]; out.state3 = field2_raw[vecIdx + 3];
    } else {
        out.state0 = field3_raw[vecIdx];
        out.state1 = field3_raw[vecIdx + 1]; out.state2 = field3_raw[vecIdx + 2]; out.state3 = field3_raw[vecIdx + 3];
    }
...
fn mixHarmPrim(a: HarmPrim, b: HarmPrim, t: f32) -> HarmPrim {
    ...
    out.state3 = mix(a.state3, b.state3, t);
    return out;
}
